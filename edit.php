...
$query=mysqli_query($connect,"SELECT *
    FROM obat
    WHERE obat.`kd_obat` ='$kd_obat'");
   $data_kmaren=mysqli_fetch_array($query);
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Data Member Arisan</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="editData.php" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <label  for="inputEmail3" class="control-label"><input type="text" name="kd_obat" value="<?php echo $data_kmaren['kd_obat']; ?>" readonly></label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Obat</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Nama obat" name="nama" value="<?php echo $data_kmaren['nama'];?>"></input>
                    </div>
                </div>
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="masukan Jenis" name="jenis" value="<?php echo $data_kmaren['jenis'];?>">
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="masukan kategori" name="kategori" value="<?php echo $data_kmaren['kategori'];?>">
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Harga</label>
                    <div class="col-sm-10">
                        <input type="text" name="harga" value="<?php echo $data_kmaren['harga'];?>" placeholder="Masukan Harga">
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Qty</label>
                    <div class="col-sm-10">
                        <input type="text" name="qty" value="<?php echo $data_kmaren['qty'];?>" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Satuan</label>
                    <div class="col-sm-10">
                        <input type="text" name="satuan" value="<?php echo $data_kmaren['satuan'];?>" placeholder="">
                    </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" name= "" class="btn btn-info pull-right" data-toggle="modal" data-target="#modal-success">Edit Obat</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
