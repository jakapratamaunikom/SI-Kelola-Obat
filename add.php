...
include("connection/connect.php");
   ...
   $prefik_id = "Obat-".date('d').date('M').date('Y')."-";

   $query=mysqli_query($connect,"SELECT COUNT(obat.`kd_obat`)+1 as sufix_id
    FROM obat
    WHERE obat.`kd_obat` LIKE '$prefik_id%'");
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Data Member Arisan</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <label  for="inputEmail3" class="control-label"><input type="text" name="kd_obat" value="<?php echo $id; ?>" readonly></label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Obat</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Nama Obat" name="nama"></input>
                    </div>
                </div>
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label">Kategori</label>
                    <div class="col-sm-10">
                      <select name="kategori"> 
                        ...
                        <option value="Non Resep Dokter">Non Resep Dokter</option>
                      </select>
                    </div>
                </div>  
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Harga</label>
                    <div class="col-sm-10">
                        <input type="text" name="harga" value="" placeholder="Masukan Harga">
                    </div>
                </div>

                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">kuantiti</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Satuan</label>
                    <div class="col-sm-10">
                        <input type="text" name="satuan" value="" placeholder="Masukan Satuan">
                    </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" name= "tambah" class="btn btn-info pull-right" data-toggle="modal" data-target="#modal-success">Tambah Obat</button>
                <a href="beranda.php" class="btn btn-primary btn-md">Kembali</a>
...
// }
          ...
          $tambahData = mysqli_query($connect, "INSERT into obat
            (
                kd_obat,
                nama,
                jenis,
      ...
      // end of cek distinct
          ...
          echo'<script>alert("Terima Kasih , Data Tersimpan"); </script>';
